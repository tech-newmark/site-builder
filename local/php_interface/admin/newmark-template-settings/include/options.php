...
class SiteSettingsManager
{
  ...
  public function getSettings(): array
  {
    return [
      ...
      'TOP_BANNER_SLIDER_NAVIGATION_ENABLED' => Option::get("main", "TOP_BANNER_SLIDER_NAVIGATION_ENABLED", "N"),
      'TOP_BANNER_SLIDER_BUTTONS_ROUNDED_ENABLED' => Option::get("main", "TOP_BANNER_SLIDER_BUTTONS_ROUNDED_ENABLED", "N"),
      'TOP_BANNER_SLIDER_BUTTONS_BORDER_ENABLED' => Option::get("main", "TOP_BANNER_SLIDER_BUTTONS_BORDER_ENABLED", "N"),
      'TOP_BANNER_SLIDER_BUTTONS_BORDER_COLOR' => Option::get("main", "TOP_BANNER_SLIDER_BUTTONS_BORDER_COLOR", "--bordered-primary"),
      'TOP_BANNER_SLIDER_BUTTONS_SIZE' => Option::get("main", "TOP_BANNER_SLIDER_BUTTONS_SIZE", "--size-sm"),
      'TOP_BANNER_SLIDER_BUTTONS_BACKGROUND_COLOR' => Option::get("main", "TOP_BANNER_SLIDER_BUTTONS_BACKGROUND_COLOR", "--background-none"),
      'TOP_BANNER_SLIDER_BUTTONS_ICON_COLOR' => Option::get("main", "TOP_BANNER_SLIDER_BUTTONS_ICON_COLOR", "--color-primary"),
  ...
  public function saveSettings(array $postData): void
  {
    ...
    $data = [
      ...
      'TOP_BANNER_SLIDER_NAVIGATION_ENABLED' => $postData["TOP_BANNER_SLIDER_NAVIGATION_ENABLED"] ?? "N",
      'TOP_BANNER_SLIDER_BUTTONS_ROUNDED_ENABLED' => $postData["TOP_BANNER_SLIDER_BUTTONS_ROUNDED_ENABLED"] ?? "N",
      'TOP_BANNER_SLIDER_BUTTONS_BORDER_ENABLED' => $postData["TOP_BANNER_SLIDER_BUTTONS_BORDER_ENABLED"] ?? "N",
      'TOP_BANNER_SLIDER_BUTTONS_BORDER_COLOR' => $postData["TOP_BANNER_SLIDER_BUTTONS_BORDER_COLOR"] ?? "--bordered-primary",
      'TOP_BANNER_SLIDER_BUTTONS_SIZE' => $postData["TOP_BANNER_SLIDER_BUTTONS_SIZE"] ?? "--size-sm",
      'TOP_BANNER_SLIDER_BUTTONS_BACKGROUND_COLOR' => $postData["TOP_BANNER_SLIDER_BUTTONS_BACKGROUND_COLOR"] ?? "--background-none",
      'TOP_BANNER_SLIDER_BUTTONS_ICON_COLOR' => $postData["TOP_BANNER_SLIDER_BUTTONS_ICON_COLOR"] ?? "--color-primary",
