...
function getSettings(): array
{
  return [
    ...
    'current-border-radius' => Option::get("main", "current-border-radius", "Без скругления"),
    ...
    'CLIENTS_PREVIEW_GRID_ITEM_FILLED_BG' => Option::get("main", "CLIENTS_PREVIEW_GRID_ITEM_FILLED_BG", "Нет"),
    'CLIENTS_PREVIEW_GRID_ITEM_BORDERED' => Option::get("main", "CLIENTS_PREVIEW_GRID_ITEM_BORDERED", "Нет"),
    'CLIENTS_PREVIEW_ICON_SIZE' => Option::get("main", "CLIENTS_PREVIEW_ICON_SIZE", "Стандартный"),
...
function saveSettings(array $postData): void
{
  ...
  $data = [
    ...
    'CLIENTS_PREVIEW_GRID_ITEM_FILLED_BG' => $postData["CLIENTS_PREVIEW_GRID_ITEM_FILLED_BG"] ?? "Нет",
    'CLIENTS_PREVIEW_GRID_ITEM_BORDERED' => $postData["CLIENTS_PREVIEW_GRID_ITEM_BORDERED"] ?? "Нет",
    'CLIENTS_PREVIEW_ICON_SIZE' => $postData["CLIENTS_PREVIEW_ICON_SIZE"] ?? "Стандартный",
